...
// Decalare varible for ages, add the sample numbers, then console log the ages. then minus ages -1 and console log it, to get 90//
...
// Declare new varible concat names, make 4 loop , set concatNames = concatNames.concat(names[i] + " "); then console.log it//
...
// ages[ages.length - 1]); was used to access the last element so we use that to access the last in the array//

console.log("last element of age array;", ages[ages.length - 1]);

// 4. How do you access the first element of any array //

// ages[0]); was used to access the first element so we use that to access the first in the array//
...
// make a, if else statement to make sure it returns true if the array is greater than 100//
...
// Declare new function calculateNumbersAverage(array), then let total = o then create a 4 loop, then have total/array.length and have it return the average.
...
// then figure out the average for both arrays then console.log and average them.
